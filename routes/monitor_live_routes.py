"""
monitor_live_routes.py — Endpoints HTTP del módulo de monitoreo en vivo.
...
@monitor_live_bp.route("/monitor/units-live", methods=["GET"])
@jwt_required
def get_units_live():
    """
...
@monitor_live_bp.route("/monitor/unit-summary/<string:imei>", methods=["GET"])
@jwt_required
